...
public:
    ...
    ChatCommandTable GetCommands() const override
    {
        static ChatCommandTable wpCommandTable =
        {
			...
			{ "move",   HandleWpMoveCommand,   rbac::RBAC_PERM_COMMAND_WP_ADD,    Console::No },
            { "delay",  HandleWpDelayCommand,  rbac::RBAC_PERM_COMMAND_WP_ADD,    Console::No },
            { "lookup", HandleWpLookupCommand, rbac::RBAC_PERM_COMMAND_WP_ADD,    Console::No },
        };
