...
template TC_GAME_API SpellScriptBase::HookList<SpellScript::OnPrepareHandler>& SpellScriptBase::HookList<SpellScript::OnPrepareHandler>::operator+=(SpellScript::OnPrepareHandler&& hook) noexcept;
template TC_GAME_API SpellScriptBase::HookList<SpellScript::OnTakePowerHandler>& SpellScriptBase::HookList<SpellScript::OnTakePowerHandler>::operator+=(SpellScript::OnTakePowerHandler&& hook) noexcept;
template TC_GAME_API SpellScriptBase::HookList<SpellScript::OnSummonHandler>& SpellScriptBase::HookList<SpellScript::OnSummonHandler>::operator+=(SpellScript::OnSummonHandler&& hook) noexcept;
